window.onload = function () {
  const firebaseConfig = {
    apiKey: "AIzaSyBu_H2aodQpd01VaZw6kwHj_yNmPwKKXD8",
    authDomain: "chatbox-ff69f.firebaseapp.com",
    databaseURL:
      "https://chatbox-ff69f-default-rtdb.asia-southeast1.firebasedatabase.app",
    projectId: "chatbox-ff69f",
    storageBucket: "chatbox-ff69f.appspot.com",
    messagingSenderId: "651281695255",
    appId: "1:651281695255:web:26105f659e266341729252",
    measurementId: "G-5SHWHXWV5K",
  };
  ...
  class MEME_CHAT {
    ...
    createJoinForm() {
      // YOU MUST HAVE (PARENT = THIS). OR NOT.
      var parent = this;
    ...
    // createChat() creates the chat container and stuff
    createChat() {
      ...
      // chat_input_send.setAttribute(true);
      ...
      chat_input.placeholder = `${parent.get_name()}. Add a message...`;
